...
class Treasurecardfav extends StatefulWidget {
  final Treasure treasure;
  final bool isFavorite;
  final VoidCallback onFavoritePressed;
  final VoidCallback onNavigatePressed;

  const Treasurecardfav({
    super.key,
  ...
  @override
  State<Treasurecardfav> createState() => _TreasurecardfavState();
}

class _TreasurecardfavState extends State<Treasurecardfav> {
  ...
  @override
  void didUpdateWidget(Treasurecardfav oldWidget) {
